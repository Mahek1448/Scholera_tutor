        ...
        >
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-24">
                ...
                >
                    ...
                    >
                        {isNewStudent
                            ? 'Welcome to Scholerа. Let’s start your learning journey.'
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 items-stretch">
                    ...
                    <div className="col-span-1 md:col-span-2 xl:col-span-3 h-full">
                        <StudyStreakCard newStudent={isNewStudent} />
                    </div>


                    <div className="col-span-1 h-full">
                        <TodayProgressCard isNewStudent={isNewStudent} />
                    </div>
                    ...
                    <div className="col-span-1 md:col-span-2 xl:col-span-2 h-full">
                        <HeatmapCard isNewStudent={isNewStudent} />
                    </div>


                    <div className="col-span-1 h-full">
                        <ContinueLearningCard isNewStudent={isNewStudent} />
                    </div>


                    <div className="col-span-1 h-full">
                        <TopicsLeftCard newStudent={isNewStudent} />
                    </div>
                    ...
                    <div className="col-span-1 md:col-span-2 xl:col-span-4">
                        <LearningMapCard isNewStudent={isNewStudent} />
                    </div>
